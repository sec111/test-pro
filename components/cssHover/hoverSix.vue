<template>
  <div>
    <div id="frozen-btn">  <button class="green">HoverSix</button>  <button class="purple">HoverSix</button></div>
  </div>
</template>
<script>
...
.purple {   background-image: linear-gradient(to right, #6253e1, #852D91);   box-shadow: 0 4px 15px 0 rgba(236, 116, 149, 0.75);}
.purple:hover:before {  background-position: left bottom;}
