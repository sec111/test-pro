<template>
  <div>
    <div id="shiny-shadow">  <button><span>HoverSeven</span></button></div>
  </div>
</template>
<script>
...
<style scoped>
#shiny-shadow {  display: flex;  align-items: center;  justify-content: center;  height: 10vh;  background: #1c2541;}
